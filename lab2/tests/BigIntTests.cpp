...
TEST(BigIntTest, to_str1) {
    BigInt a("823476324769329672346948360000000000000000000000000003487");
    EXPECT_EQ(a.to_string(), "823476324769329672346948360000000000000000000000000003487");
}

TEST(BigIntTest, fft1) {
    BigInt m1("163546836823648235");
    BigInt m2("398469834679");
    EXPECT_EQ(m1.fft_multiply2(m2), BigInt("65168481031392501678100141565"));
}

TEST(BigIntTest, fft2) {
    BigInt m1("8713448518346513487365");
    BigInt m2("78136457136457738456345778135");
    EXPECT_EQ(m1.fft_multiply2(m2), BigInt("680837996664513541174777540821422001325853415764275"));
}

TEST(BigIntTest, fft3) {
    BigInt m1("145737941730561374163745134060138465");
    BigInt m2("813604756137465716347851834561374561378465781");
    EXPECT_EQ(m1.fft_multiply2(m2), BigInt("118573082541669575128571672620723852205245717984879540134406212435608870124366165"));
}

TEST(BigIntTest, fft4) {
    BigInt m1("1457379417305613741637451340601384651437386573647567834656234657");
    BigInt m2("8136047561374657163478518345613745613784657818436823462346");
    EXPECT_EQ(m1.fft_multiply2(m2), BigInt("11857308254166957512857167262072385232219217338061575206146578788245209147570275791422874495711039910954036899546179725322"));
}

TEST(BigIntTest, fft5) {
    BigInt m1("145737941730561374163745134060138465143738657364756783465623465789493265348679883247689496783462347236236");
    BigInt m2("813604756137465716347851834561374561378465781843682346234689456728469475672847568247672467");
    EXPECT_EQ(m1.fft_multiply2(m2), BigInt("118573082541669575128571672620723852322192173380615752061478825194745328902050212447421984923104214911081542679715785855140330014504730267322021116192226606399316508188232571921598415657201914212"));
}
